...
var chain = function CruxRouteChain(routeName, routePath, routeMethod) {
  ...
  this.callback = function OnChainReached() {
    ...
    function doThenCallback() {
      ...
      //console.log(thenFn.toString(), chainArguments);
      try {
      ...
      if(typeof thenResult !== 'object') return;
      if(typeof thenResult.then !== 'function' || typeof thenResult.error !== 'function') return;
