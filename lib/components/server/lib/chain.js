...
chain.prototype.then = function RouteThen(callCallback) {
  if(typeof this.callback === 'function') {
    throw new Error("Endpoint " + this.name + ' has already a registered callback.');
  }
...
* */
chain.prototype.preValidate = function PreValidation() {};
...
* */
chain.prototype.postValidate = function OnPostValidation(done) { done() };
