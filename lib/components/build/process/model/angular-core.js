...
var core = function CruxBuildAngularCore(config) {
...
core.default = {
  ...
  path: 'front/app',
  entry: 'app.js',
  config: 'config.js',  // This is the configuration file that we include before the app.js file. We can also use $environment in this
...
core.prototype.__readFiles = function ReadFiles() {
  try {
    ...
    this.FILE_CACHE = [];
    // We now exclude all other config/ stuff in the files.
