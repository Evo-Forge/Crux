...
var process = function KruxBuildCommonjs() {
...
process.prototype.packages = function Dependencies() {
  var req = ['browserify@8.0.3', 'aliasify@1.5.1'];
...
process.prototype.init = function Initialize() {
  if(this.paths.length > 1) {
    throw new Error('Krux.build.commonjs: This process only supports one source directory.');
  }
...
process.default = {
  ...
  extension: '.js',
  uglify: false,
  output: 'app/public/build/app.build.js'
};
