...
DbService.prototype.init = function InitializeDB() {
  ...
  if(this.config.dialectOptions){
    opt['dialectOptions'] = this.config.dialectOptions //  e.g utf8, utf8mb4
  }
...
DbService.prototype.attach = function AttachDatabase() {
  process.nextTick(function() {
    ...
    this.registry().attachTo('server service tasks io', 'sqlQuery', sqlQuery.bind(this));
  }.bind(this));
};
