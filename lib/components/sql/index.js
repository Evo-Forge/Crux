  ...
  process.nextTick(function() {
    ...
    function startTransaction(_mode, _options) {
      ...
      return crux.promise(function(resolve, reject) {
        ...
        var transactionPromise = self.Seq.transaction(_options).then(function(t) {
    ...
    this.registry().attachTo('server service io', 'transaction', startTransaction.bind(this));
  }.bind(this));
};
...
DbService.prototype.dump = function CreateSqlDump(saveOpt, dumpOptions) {
  ...
  return crux.promise(function(resolve, reject) {
    ...
    log.info('Crux.SQL: Generating dumpfile...');
