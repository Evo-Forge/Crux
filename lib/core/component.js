...
function ComponentClass() {
  ...
  * */
  ...
  /*
  * Returns an array of npm packages that require to be installed. This is required to be
  * overridden by all components that require external dependencies. The packages
  * are installed BEFORE we call their init() method.
  * */
