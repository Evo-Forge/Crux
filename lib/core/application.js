...
function createApp() {
  ...
  * */
  ...
  /*
  * This will set the configuration directory for environment-specific configurations.
  * */
  ...
  * This will return everything that is in projectConfig overwritten by appConfig.
  * */
  ...
  * */
  function initCustomComponents() {
    ...
    _.forEach(componentList, function(compName) {
      ...
      var compConfig = getComponentConfiguration('custom' + compName);
      var compObj = new CompClass(compConfig, appConfig);
      if(compObj.name === 'CruxComponent') {
